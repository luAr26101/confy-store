## These are the steps needed I you want to setup this project from scratch

- [Final Project](https://react-vite-comfy-store-v2.netlify.app/)
...
- replace content in vite.config.ts with
...
- remove App.css
- remove all assets from `src/assets`
- delete contents of `index.css` and add the following:

```css
@import "tailwindcss";
```

- delete contents of App.tsx and change it
...
function App() {
  return (
    <>
      <h1 className="text-3xl font-black">Comfy store</h1>
    </>
  );
}
...
- Add class sorting with prettier. For this we use the official [Prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) for Tailwind CSS that automatically sorts your classes
